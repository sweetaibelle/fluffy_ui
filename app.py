    ...
    with gr.Row(equal_height = True):
        with gr.Column():
            ...
            with gr.Column():
                ...
                #with gr.Row():
                    seed = gr.Number(label="Seed", value = 0, step = 1, minimum = 0, maximum = 18446744073709551614, precision = 0)
                    steps = gr.Number(label="Steps", value = 50, step = 1, minimum = 1, maximum = 1000, precision = 0)
                    cfg = gr.Number(label="cfg", value = 7, step = 0.1, minimum = 1, maximum = 20, precision = 1)
            ...
            with gr.Accordion(label = "FreeU & CFG Rescale", open = False):
                ...
                with gr.Row():
                    b1 = gr.Number(label="B1", value = 1.3, step = 0.1, minimum = 0.1, maximum = 2.0, precision = 1)
                    b2 = gr.Number(label="B2", value = 1.4, step = 0.1, minimum = 0.1, maximum = 2.0, precision = 1)
                    s1 = gr.Number(label="S1", value = 0.9, step = 0.1, minimum = 0.1, maximum = 2.0, precision = 1)
                    s2 = gr.Number(label="S2", value = 0.2, step = 0.1, minimum = 0.1, maximum = 2.0, precision = 1)
                rescale = gr.Number(label="CFG Rescale", value = 0.7, step = 0.1, minimum = 0.1, maximum = 2.0, precision = 1)
